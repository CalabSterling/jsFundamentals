...
for(number of numbers){
    console.log(number);
    sumOfAllNumbers = number + sumOfAllNumbers;
...
for (pie of pies){
    if(pie.includes('apple') || pie.includes('blueberry') || pie.includes('cherry')){
            console.log(`${pie} is of the type fruit pie`);
    } else {
        console.log(`${pie} is not of the type fruit pie`);
    }
}
...
for (pie of pies){
    if (pie.includes('apple')){
        ...
        console.log(`${pie} is not of type apple.`)
    )
}
